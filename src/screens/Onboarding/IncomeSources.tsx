/**
 * screens/Onboarding/IncomeSources.tsx — Onboarding Step 3 — income sources (Phase 7).
...
const OnboardingIncomeSources: React.FC = () => (
  <IonPage>
    <IonHeader>
      <IonToolbar>
        <IonTitle>OnboardingIncomeSources</IonTitle>
      </IonToolbar>
    </IonHeader>
    <IonContent fullscreen>
      <main className="amban-screen">
        <h2>OnboardingIncomeSources</h2>
...
export default OnboardingIncomeSources;
