...
export const BUILD_INFO = {
  /** Semver string from package.json (e.g. "0.3.10"). */
  version: safe(typeof __APP_VERSION__ !== "undefined" ? __APP_VERSION__ : undefined, "0.3.10-dev"),
...
/** Compact "amban · 0.3.10 (abc1234)" string for the About row. */
