...
export const BUILD_INFO = {
  /** Semver string from package.json (e.g. "0.1.3"). */
  version: safe(typeof __APP_VERSION__ !== "undefined" ? __APP_VERSION__ : undefined, "0.1.3-dev"),
...
/** Compact "amban · 0.1.3 (abc1234)" string for the About row. */
